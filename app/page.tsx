      ...
      <div className="bg-card border-b">
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-center text-gray-900 dark:text-white mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-2">
              <span>
